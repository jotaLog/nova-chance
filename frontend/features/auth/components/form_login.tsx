...
export function FormLogin() {
  ...
  if (!keepMachine) {
    console.log("conectado a maquina");
  }
    ...
    >
      ...
      {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <View style={styles.container_enter}>
          <TouchableOpacity style={styles.enter_methods}>
            ...
            <Text style={styles.enterMethods_txt_cont}> Continuar com Google</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.enter_methods}>
            ...
            <Text style={styles.enterMethods_txt_cont}> Continuar com Telefone</Text>
          </TouchableOpacity>
        </View>
      ...
      {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <View style={styles.inputGroup}>
          ...
          <View style={styles.container_problem_login}>
            <Text style={styles.problem_with_login_content}>Problemas ao acessar sua conta?</Text>
          </View>
        </View>
      ...
      {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <View style={styles.container_keep_machine}>
          ...
          <Text style={styles.keep_machine_txt}>
              Manter conectado nesta maquina
          </Text>
        </View>
      ...
      {/* /////////////////////////////////////////////////////////////////////////////////////////////////////////////// */}
        ...
        <View style={styles.container_dont_have_account}>
          <Text style={styles.dont_have}>
            Não tem uma conta? <Text style={styles.login_link}>Cadastrar</Text>
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  container_problem_login: {
    width: "100%",
  },

  problem_with_login_content: {
    color: "#3CFF00",
    fontSize: 12,
